...
An earlier multimodal embedding model from Meta AI (2023) that also maps multiple modalities into a shared space. We initially considered ImageBind but chose Gemini Embedding 2 because:

- ImageBind lacks native Korean language support
- It requires local GPU inference (no managed API)
- Gemini's audio encoder handles speech content more effectively for our use case
