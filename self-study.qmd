...
- Devlin, J., Chang, M., Lee, K., & Toutanova, K. (2019). BERT: Pre-training of deep bidirectional transformers for language understanding. *NAACL-HLT*, 4171-4186. [arXiv](https://arxiv.org/abs/1810.04805)
...
- Reimers, N. & Gurevych, I. (2019). Sentence-BERT: Sentence embeddings using Siamese BERT-Networks. *EMNLP*, 3982-3992. [arXiv](https://arxiv.org/abs/1908.10084)
...
- Girdhar, R., El-Nouby, A., Liu, Z., et al. (2023). ImageBind: One embedding space to bind them all. *CVPR*, 15180-15190. [arXiv](https://arxiv.org/abs/2305.05665)
